...
<!-- BEGIN participantesEscritura.jsp -->
<jsp:include page="../includes/cabecera.jsp"/>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
         REGISTRO DE PARTICIPANTES MENCIONADOS EN OFICIO
      </div>
		...
		<div class="col-lg-12">                        
	  	...
	  	<table class="bloqueTablaLineal" >
	       <tr>
	         ...
	         <td>
	                       <input type="button" onclick="javascript:nuevo();" class="btn btn-success" value="Nueva Persona">
	       ...
	       <tr>
	           ...
	           <td valign="middle">
	            ...
	            <td valign="middle">
					<input type="button" onclick="javascript:agregar();" class="btn btn-success" value="Agregar">
	           </td>
	       </tr>
	    </table>
    ...
    <div class="row">
 	...
 	<div class="row">
	    <div class="col-lg-12">
			<input type="button" onclick="javascript:cancelar();" class="btn btn-success" value="Regresar">	    
	    </div>
    </div>
...
<!-- END participantesEscritura.jsp -->
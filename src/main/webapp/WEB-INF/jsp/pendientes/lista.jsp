								...
								defaultorder="ascending" export="false" id="row" excludedParams="ajax">
									...
									<display:column title="Acciones" sortable="true" headerClass="sortable" style=" width: 80px;">
										<c:if test="${row.estado==1}">
                                    		<a href="javascript:firmar(${row.escritura.idEscritura},${row.solicitud.idsolicitud});" style="border: 0px;" title="Firmar"><img src="${pageContext.request.contextPath}/images/edit.png" width="18" height="18" border="0"></a>
                                    	</c:if>
                                    </display:column>
							 </display:table>
		 				</div>
